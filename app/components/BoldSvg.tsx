/** Inline Bold.svg from public/SVG/Bold.svg with configurable fill for theme. */
export default function BoldSvg({ className, fill = '#F5BE27' }: { className?: string; fill?: string }) {
  return (
    <svg
